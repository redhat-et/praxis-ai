...
| [reject-upgrade.yaml](configs/reject-upgrade.yaml) | Rejects HTTP/1.1 connection-upgrade requests so metering and token filters continue to observe the exchange |
